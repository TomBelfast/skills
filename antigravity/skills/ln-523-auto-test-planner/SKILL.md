...
**MANDATORY READ:** Load `resources/risk_based_testing_guide.md` for complete methodology.
...
- **Auto-discovery patterns:** `shared/resources/auto_discovery_pattern.md`

### risk_based_testing_guide.md

**Purpose**: Risk-Based Testing methodology (detailed guide)

**Location**: [resources/risk_based_testing_guide.md](resources/risk_based_testing_guide.md)
