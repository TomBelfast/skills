...
- [syntax.md](resources/syntax.md) — Complete syntax specification and rules
- [templates.md](resources/templates.md) — All available templates with descriptions
- [examples.md](resources/examples.md) — Full examples for each template category
