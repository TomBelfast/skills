...
Load `resources/persona-catalog.md` to determine which specialists activate for this diff.
...
Four angles to check (load `resources/persona-catalog.md` for detail):
