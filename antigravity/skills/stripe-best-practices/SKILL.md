...
| ------------------------------------- | ----------------------------------- | ------------------------ |
| One-time payments                     | Checkout Sessions                   | <resources/payments.md> |
| Custom payment form with embedded UI  | Checkout Sessions + Payment Element | <resources/payments.md> |
| Saving a payment method for later     | Setup Intents                       | <resources/payments.md> |
| Connect platform or marketplace       | Accounts v2 (`/v2/core/accounts`)   | <resources/connect.md>  |
| Subscriptions or recurring billing    | Billing APIs + Checkout Sessions    | <resources/billing.md>  |
| Embedded financial accounts / banking | v2 Financial Accounts               | <resources/treasury.md> |
