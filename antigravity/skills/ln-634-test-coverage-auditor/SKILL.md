...
**MANDATORY READ:** Load `shared/resources/task_delegation_pattern.md#audit-coordinator--worker-contract` for contextStore structure.
...
**MANDATORY READ:** Load `shared/resources/audit_scoring.md` for unified scoring formula.
