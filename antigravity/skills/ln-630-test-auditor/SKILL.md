...
2. Load [../shared/resources/risk_based_testing_guide.md](../shared/resources/risk_based_testing_guide.md)
...
- **Orchestrator lifecycle:** `shared/resources/orchestrator_pattern.md`
- **Risk-based testing methodology:** `shared/resources/risk_based_testing_guide.md`
- **Task delegation pattern:** `shared/resources/task_delegation_pattern.md`
- **Audit scoring formula:** `shared/resources/audit_scoring.md`
- **Audit output schema:** `shared/resources/audit_output_schema.md`
...
- **Reference:**
  - [../shared/resources/risk_based_testing_guide.md](../shared/resources/risk_based_testing_guide.md) — Risk-Based Testing Guide
