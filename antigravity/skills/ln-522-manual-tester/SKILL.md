...
**See:** [resources/templates/](resources/templates/)

| Template | Use Case | Location |
|----------|----------|----------|
| template-api-endpoint.sh | API endpoint tests (NO async jobs) | [template-api-endpoint.sh](resources/templates/template-api-endpoint.sh) |
| template-document-format.sh | Document/file processing (WITH async jobs) | [template-document-format.sh](resources/templates/template-document-format.sh) |

**Quick start:**
```bash
cp resources/templates/template-api-endpoint.sh {NN}-feature/test-{feature}.sh      # Endpoint tests
cp resources/templates/template-document-format.sh {NN}-feature/test-{format}.sh    # Document tests
```
...
- Risk-based context: `shared/resources/risk_based_testing_guide.md`
