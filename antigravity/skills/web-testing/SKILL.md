...
### Core Testing
- `./resources/unit-integration-testing.md` - Unit/integration patterns
- `./resources/e2e-testing-playwright.md` - Playwright E2E workflows
- `./resources/component-testing.md` - React/Vue/Angular component testing
- `./resources/testing-pyramid-strategy.md` - Test ratios, priority matrix
...
- `./resources/shadow-dom-testing.md` - Web components testing

### Interactive & Forms
- `./resources/interactive-testing-patterns.md` - Forms, keyboard, drag-drop
...
### Accessibility
- `./resources/accessibility-testing.md` - WCAG checklist, axe-core

### Security
- `./resources/security-testing-overview.md` - OWASP Top 10, tools
- `./resources/security-checklists.md` - Auth, API, headers
- `./resources/vulnerability-payloads.md` - SQL/XSS/CSRF payloads

### API & Load
- `./resources/api-testing.md` - API test patterns
- `./resources/load-testing-k6.md` - k6 load test patterns
