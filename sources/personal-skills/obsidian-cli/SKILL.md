...
name: obsidian-cli
description: >-
  Obsidian vault automation w tym repozytorium — używaj wyłącznie dokumentu
  kanonicznego i helpera obsidian-rest. Nie stosuj przykładów z oficjalnego
  `obsidian` CLI ani npm `obsidian-cli` tutaj bez sprawdzenia OBSIDIAN_KB.md.
---
